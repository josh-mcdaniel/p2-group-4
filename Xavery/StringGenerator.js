...
function stringGenerator () {
  let x = 0;
       ...
       charOne = Math.floor(Math.random() * readyAlphaCharArray.length);
       charTwo = Math.floor(Math.random() * readyAlphaCharArray.length);
 ...
 return(`${readyAlphaCharArray[charOne]}
        ${readyAlphaCharArray[charTwo]}
